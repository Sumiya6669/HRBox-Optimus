...
const INTEGRATIONS = [
  {
    id: 'zup',
    name: '1С:ЗУП',
    desc: 'Выгрузка кадровых событий и графика отпусков из учётной системы.',
    stage: 'В проработке: согласуется формат обмена с бухгалтерией.',
  },
  {
    id: 'bitrix',
    name: 'Битрикс24',
    desc: 'Синхронизация оргструктуры и задач адаптации новых сотрудников.',
    stage: 'В плане на следующий квартал.',
  },
  {
    id: 'sso',
    name: 'SSO: Google Workspace / Microsoft Entra ID',
    desc: 'Единый вход по корпоративной учётной записи вместо пароля портала.',
    stage: 'Ожидает решения по корпоративному тенанту.',
  },
  {
    id: 'telegram',
    name: 'Telegram',
        ...
        <TabsContent value="integrations">
          <Card className="p-6">
            ...
            <p className="mb-4 text-sm text-muted-foreground">
              Ни одна внешняя система пока не подключена. Ниже — планируемые интеграции и их статус;
